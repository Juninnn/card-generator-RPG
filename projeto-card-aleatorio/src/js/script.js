...
const classes = [
  ...
  },
  {
    id: 5,
    nome: "Guerreiro",
    img: "./assets/img/classe/guerreiro.png"
  },
  {
    id: 6,
    nome: "Ladino",
...
card.innerHTML += `<li> Nome do Aventureiro: ${personagem.nome}</li>`
card.innerHTML += `<li> Classe: ${personagem.classeNome} </li>`;
card.innerHTML += `<li> Nivel: ${personagem.nivel} </li>`;

for (let atributos in personagem.atributos)
  card.innerHTML += `<li>${atributos}: ${personagem.atributos[atributos]} </li>`;
...
// const reset = document.getElementById("botao");
// if (
// reset.click = true
